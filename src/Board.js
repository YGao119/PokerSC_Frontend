            ...
            <div>
                <div class="container">
                    ...
                    <div class="row row-cols-9">
                        <ActionUI2 min={1} max={100} canCheck={false}></ActionUI2>
                    ...
                    <div class="row row-cols-9">
                        ...
                        <div class="col grid_item"></div>
                        {playerUI("5126","Jason", 1212, "", "hk", "dk", true, true, false, false, 100, false, this.state.checkedPlayer)}
                        <div class="col grid_item"></div>
                    ...
                    <div class="row row-cols-9">
                        <div class="col grid_item"></div>
                        <ActionUI min={1} max={100} canCheck={false}></ActionUI>
                        <div class="col grid_item"></div>
                    </div>
                </div>
...
/*function ActionUI(canCheck, min, max) {
    return (
        <div class="col grid_item">
            ...
            <div className="action_button" onClick={() => { }}><p style={{ color: "white", fontSize: "8px", marginLeft: "-20px" }} className="pixel_text">{canCheck ? "Check" : "Call"}</p></div>
            <div className="action_button" onClick={() => { }} ><p style={{ color: "white", fontSize: "8px", marginLeft: "-20px" }} className="pixel_text">Raise</p></div>
