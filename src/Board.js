        ...
        if (isEmpty) {
            return (
                <div class="col-3 grid_item">
                    <img onClick={()=>{this.setBuyinModal(thisPos)}} src={userboxUri} style={{ cursor: "pointer", zIndex: "5", position: "relative", height: "125px", opacity: "80%" }}></img>
